...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/anirudtate/dotfiles"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/anirudtate/auto-rice/master/progs.csv"
